...
# MASSL:  In the attention-based version of our method, which we call Multi-taskAttention-based SSL 
# (MASSL), they reconstruct separately background and fore-ground parts of the image, 
# as defined by the soft predictions ̃yobtained from the segmentation network.
# _alter: Alternating training
job_list = [
            'MASSL_alter',
            # 'MASSL_joint',
            ]
